#include "cpu.h"
#include "config.h"
#include "InternalTemperature.h" //to read teensy temp

//#if defined(__SAMD51__)
#ifdef __SAMD51__  //adafruit GCM4
#include <sam.h>
...
float GetCPUTemperature()
{
  float temperatureTeensy = InternalTemperature.readTemperatureC();
  return temperatureTeensy;
}
